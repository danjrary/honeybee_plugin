...
var apiurl={
  notifydata:"https://awiclass.monoame.com/api/command.php?type=get&name=notifydata",
  itemdata:"https://awiclass.monoame.com/api/command.php?type=get&name=itemdata",
  hahowdata:"https://awiclass.monoame.com/api/command.php?type=get&name=hahowdata"
}
...
// 課程中使用ready代表: 虛擬機器(vm)準備好的時候，執行把資料載入；不過在Vue 2.x版本，ready要改為mounted
...
// 由於itemdata是由陣列［］組成，所以要先用JSON.parse轉換為JSON物件之後，才可以使用
...
output1.innerHTML = jcontent.name;